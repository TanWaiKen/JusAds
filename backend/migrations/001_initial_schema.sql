...
CREATE TABLE public.compliance_checks (
  ...
  CONSTRAINT compliance_checks_task_id_fkey FOREIGN KEY (task_id) REFERENCES public.tasks(id),
...
CREATE TABLE public.violations (
  ...
  CONSTRAINT violations_task_id_fkey FOREIGN KEY (task_id) REFERENCES public.compliance_checks(task_id)
);