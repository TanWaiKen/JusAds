...
class ImageRemediator:
    ...
    def remediate(
        ...
        """Analyze a non-compliant image and produce a compliant redesign prompt.
        ...
        Returns:
            Dict with compliant_image_prompt and changes_suggested.
        """
        # Load the original image bytes so Gemini can see what needs fixing
        try:
