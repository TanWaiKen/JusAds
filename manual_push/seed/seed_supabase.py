...
Usage:
    python manual_push/seed/seed_supabase.py
    python manual_push/seed/seed_supabase.py --rules-only
    python manual_push/seed/seed_supabase.py --personas-only
    python manual_push/seed/seed_supabase.py --platform-rules
"""
...
# This is an operator tool; keep its datasets outside the deployed backend.
...
CSV_PATH = ASSETS_DIR / "regulatory_rules_vector_db_dataset.csv"
