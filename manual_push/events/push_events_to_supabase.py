...
Usage:
  .venv/Scripts/python manual_push/events/push_events_to_supabase.py
"""
...
def main() -> None:
    ...
    # Read CSV
    csv_path = os.path.join(PROJECT_ROOT, "manual_push", "data", "cultural_events_sea_full_2026.csv")
