...
Saves results to manual_push/data/cultural_events_sea_<date>.csv.

Usage:
  .venv/Scripts/python manual_push/events/fetch_sea_events.py
"""
...
async def main() -> None:
    ...
    # Save to CSV
    csv_dir = os.path.join(PROJECT_ROOT, "manual_push", "data")
    os.makedirs(csv_dir, exist_ok=True)
    today_str = datetime.now().strftime("%Y%m%d")
    csv_path = os.path.join(csv_dir, f"cultural_events_sea_{today_str}.csv")
